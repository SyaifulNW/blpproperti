...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('penilaian-cs/export-pdf', [PenilaianCsController::class, 'exportPdf'])
        ->name('penilaian-cs.exportPdf');
});
...
Route::post('/admin/database/update-inline', [DataController::class, 'updateInline'])->name('admin.database.update-inline');
...
Route::get('/admin/kpr', function () {
    return redirect()->route('admin.salesplan.index');
})->name('admin.kpr.index');
